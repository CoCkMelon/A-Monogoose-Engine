// Phantom OS backend: POSIX-compatible worker reading keyboard and PS/2 mouse devices.
...
#if defined(PHANTOMOS) || defined(__PHANTOM__) || defined(PHANTOM_OS)
...
#else
/* Not Phantom OS build */
typedef int phantom_nonempty;
#endif
